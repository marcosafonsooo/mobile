...
export default function TabLayout() {
  ...
  <Tabs
    ...
    screenOptions={{tabBarActiveTintColor: '#49093e',

      headerStyle:{
        backgroundColor:'#ffe7fa',
      }, 
      
      headerShadowVisible: false, headerTintColor: '#49093e',
  ...
  >
    ...
    <Tabs.Screen name = "about" options={{ 
      ...
      tabBarIcon:({color, focused})=> (
      <MaterialCommunityIcons name={focused ? 'image-frame' : 'image-filter-frames'} color={color} size ={24}/>) //icone
    }}/>
